...
public class FileSystemUI {
	...
	private String path = "D:\\Documents\\GitHub\\File-manager\\src\\FileSystem\\";
	/**
	...
	private void initialize() {
		...
		ImageIcon icon = new ImageIcon(path+"addFolder.png");
		...
		ImageIcon icon1 = new ImageIcon(path+"addFile.png");
...
class MyTreeCellRenderer extends DefaultTreeCellRenderer {
	...
	public java.awt.Component getTreeCellRendererComponent(JTree tree,
		...
		if (value.toString().equals("PC")) {
			ImageIcon icon = new ImageIcon(path+"computer.png");
			icon.setImage(icon.getImage().getScaledInstance(24, 24,
					Image.SCALE_DEFAULT));
			setIcon(icon);
		} else if (leaf) {
			ImageIcon icon = new ImageIcon(path+"emptyFolder.png");
			icon.setImage(icon.getImage().getScaledInstance(24, 24,
					Image.SCALE_DEFAULT));
			setIcon(icon);
		} else if (expanded) {
			ImageIcon icon = new ImageIcon(path+"openedFolder.png");
			icon.setImage(icon.getImage().getScaledInstance(24, 24,
					Image.SCALE_DEFAULT));
			setIcon(icon);
		} else {
			ImageIcon icon = new ImageIcon(path+"closedFolder.png");
			icon.setImage(icon.getImage().getScaledInstance(24, 24,
					Image.SCALE_DEFAULT));
			setIcon(icon);
		}
